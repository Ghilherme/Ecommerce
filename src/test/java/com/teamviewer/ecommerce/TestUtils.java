...
public class TestUtils {
    ...
    public static final String ORDER_ITEM_ENDPOINT = "/api/order-items";
    ...
    public static final String ORDER_ITEM_ID = "6a28c675-1499-46c5-a404-64c1075c0b37";
    ...
    public static final String ORDER_ITEM_ID_ENDPOINT = ORDER_ITEM_ENDPOINT + "/" + ORDER_ITEM_ID;
